...
import net.frozenorb.qmodsuite.menu.OnlineStaffMenu;
import net.frozenorb.qmodsuite.utils.ModUtils;
import net.frozenorb.qmodsuite.utils.StaffItems;
import net.frozenorb.qmodsuite.utils.chest.ChestUtils;
...
public class GeneralListener implements Listener {
   ...
   @EventHandler
   public void onRegister(PlayerRegisterCBEvent event) {
      Player player = event.getPlayer();
